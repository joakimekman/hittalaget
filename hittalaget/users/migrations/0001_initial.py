# Generated by Django 3.0 on 2020-02-06 12:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height', models.PositiveIntegerField(blank=True, help_text='längd i cm', null=True, verbose_name='längd')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='users.City', verbose_name='stad')),
